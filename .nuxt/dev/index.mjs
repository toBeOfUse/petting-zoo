...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getCookie, readBody, setCookie, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/devalue/index.js';
import { renderToString } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/projects/nuxt-starter-5gyfh8/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/home/projects/nuxt-starter-5gyfh8/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/projects/nuxt-starter-5gyfh8","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/projects/nuxt-starter-5gyfh8/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/projects/nuxt-starter-5gyfh8/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/projects/nuxt-starter-5gyfh8/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/projects/nuxt-starter-5gyfh8/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _D2kJGqYf2a = (function(nitro) {
...
const _lazy_WiWgXO = () => Promise.resolve().then(function () { return loadzoo$1; });
const _lazy_TIbc0d = () => Promise.resolve().then(function () { return login$1; });
const _lazy_Ho6HiI = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/loadzoo', handler: _lazy_WiWgXO, lazy: true, middleware: false, method: undefined },
  { route: '/api/login', handler: _lazy_TIbc0d, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Ho6HiI, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Ho6HiI, lazy: true, middleware: false, method: undefined }
];
...
function findUserWithUsername(soughtUsername) {
...
const getClientManifest = () => import('file:///home/projects/nuxt-starter-5gyfh8/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/projects/nuxt-starter-5gyfh8/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
